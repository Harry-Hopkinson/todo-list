...
const newListInput : any = document.querySelector("[data-new-list-input]");
const deleteListButton = document.querySelector("[data-delete-list-button]");
const listDisplayContainer : any = document.querySelector(
  "[data-list-display-container]"
);
const listTitleElement = document.querySelector("[data-list-title");
const listCountElement : any = document.querySelector("[data-list-count");
const tasksContainer = document.querySelector("[data-tasks");
const taskTemplate : any = document.querySelector("#task-template");
const newTaskForm : any = document.querySelector("[data-new-task-form]");
const newTaskInput : any = document.querySelector("[data-new-task-input]");
const newTaskDate : any = document.querySelector("#due-date");
const newTaskPriority : any = document.querySelector("#priority");
const newTaskDescription : any = document.querySelector("#description");
...
const formContainer : any = document.querySelector(".container");
const closeButton = document.querySelector(".close");
const addButton : any = document.querySelector(".add-btn");
...
function colorTasks(selectedList) {
  ...
  const checkbox : any = document.querySelectorAll(".checkbox");
...
function openOrCloseAddTaskForm() {
  const h2 = document.querySelector(".container h2");
  const submitInput : any = document.querySelector(`input[type="submit"]`);
...
//display list tasks
listsContainer.addEventListener("click", (e : any) => {
...
tasksContainer.addEventListener("click", (e : any) => {
